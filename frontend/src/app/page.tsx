...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#dbead7] to-[#254d32] font-sans">
      {/* Header */}
      ...
      <main className="flex flex-col items-center flex-1 px-4 text-center justify-center">
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-extrabold mb-4 text-[#254d32] leading-tight">
          One partner.<br />
          <span className="text-[#37624e]">Infinite contexts.</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-10">
          ...
          <span className="text-[#254d32] text-base font-light">College students only • Free to join</span>
        </div>
        {/* Feature Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 w-full max-w-5xl mb-12">
          {features.map((f, i) => (
            <div key={i} className="bg-white/70 rounded-xl p-6 flex flex-col items-center shadow hover:shadow-lg transition">
